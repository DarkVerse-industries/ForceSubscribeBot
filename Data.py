...
By @DarkVerseIndustries
    ...
    buttons = [
        ...
        [InlineKeyboardButton("🎨 Support Group 🎨", url="https://t.me/CastleOfFriendship")],
    ]
...
A telegram force subscribing bot by @DarkVerseIndustries

Source Code : [Click Here](https://github.com/DarkVerse-industries/ForceSubscribeBot)

Framework : [Pyrogram](docs.pyrogram.org)

Language : [Python](www.python.org)

Developer : @DarkLegend_088
    """
